...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="" >
                    <table class="table table-striped table-bordered supplierList" id="supplierList" >
                        <thead>
                        <tr>
                            <th>SL</th>
                            <th>Name</th>
...
@push('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            var supplierList = $('#supplierList').dataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: '{{ route('supplier-show-json') }}',
                    type: "POST",
                    data: function (d) {
